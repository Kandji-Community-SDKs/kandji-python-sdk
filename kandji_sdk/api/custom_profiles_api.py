...
class CustomProfilesApi:
    ...
    def create_custom_profile(
        ...
        active: Annotated[StrictStr, Field(description="(Optional, default=true) Whether this library item is active")],
        ...
        :param name: (Required) The profile name (required)
        :type name: str
        :param file: (Required) The path to the profile's .mobileconfig file (required)
        :type file: bytearray
        :param active: (Optional, default=true) Whether this library item is active (required)
        :type active: str
